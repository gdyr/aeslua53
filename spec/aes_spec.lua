...
local pw = "password";
local dt = "test";
print('test', strtohex(aeslua.encrypt(pw, dt)));
print('act', strtohex(crypto.encrypt('AES128', dt, pw)));

describe('aeslua53', function()
  it('performs 1000 random en-/decryptions successfully...', function()
    assert.is_true(testnAES(1000));
  end);
end);
